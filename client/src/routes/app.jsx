...
const appRoutes = [ 
    ...
    { path: "/home/payments", name: "Payments", icon: "pe-7s-cash", component: Payments, isSidebarMenuLink: true },
    { path: "/home/survey", name: "Survey", icon: "pe-7s-speaker", component: Survey, isSidebarMenuLink: true },
...
/*    { path: "/home/table", name: "Table List", icon: "pe-7s-note2", component: TableList },
    ...
    { path: "/home/notifications", name: "Notifications", icon: "pe-7s-bell", component: Notifications, isSidebarMenuLink: true },
